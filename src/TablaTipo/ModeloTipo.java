...
/**
 * Clase ModeloTipo Funciona para declarar el modelo de la tabla de tipos de
 * proyectos
 */
public class ModeloTipo implements TableModel {
	 ...
	 */
	public void borraTipo(int fila) {
		datos.remove(fila);
	 ...
	 */
	public void anhadeTipo(String tipo) {
		datos.add(tipo);
