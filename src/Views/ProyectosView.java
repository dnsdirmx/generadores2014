...
public class ProyectosView extends JInternalFrame {
	 ...
	 * @param escritorio2 --- panel de la aplacaci�n principal 
	...
	private void initGUI(final JDesktopPane escritorio2, final Metodos cone) {
		try {
			...
			agregar.addActionListener(new ActionListener() {
				/**
				 * opci�n para agregar un nuevo proyecto
				 * (non-Javadoc)
			...
			modificar.addActionListener(new ActionListener() {
				/**
				 * Opci�n para actualizar la informaci�n de un proyecto
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
			...
			eliminar.addActionListener(new ActionListener() {
				/**
				 * opci�n para eliminar un proyecto
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
			...
			// Agrupaci�n de los botones radios
			...
			Cproyectos.addActionListener(new ActionListener() {
				/**
				 * Listener para desplegar la informaci�n del proyecto seleccionado
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
			...
			bproyecto.addActionListener(new ActionListener() {
				/**
				 * opci�n para crear nuevos tipos de proyecto
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
			...
			// Botón para agregar, modificar o eliminar un proyecto
			...
			btnComments.addActionListener(new ActionListener() {
				/**
				 * opci�n para agregar o actualizar la informaci�n de los comentarios del proyecto
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
			...
			aceptar.addActionListener(new ActionListener() {
				/**
				 * opci�n para guardar / actualizar o eliminar un proyecto 
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
					...
					/**
					 * validaci�n para las fechas, la fecha final no debe ser menor a la fecha de inicio
					 */
					try {
						if (Ffin.getCalendar().before(finicial.getCalendar())){
							JOptionPane.showMessageDialog(null, "Atenci�n con la fecha final del proyecto. No puede ser menor a la de inicio.");
							return;
						}	
					} catch (Exception e2) {
							...
							try {
								...
								//if (cone.existeproyecto(nombre.getText()) == false) {
									...
									if (controlador.create(p.getIdtipo(), finicial.getDate(), Ffin.getDate(), descripcion.getText(), nombre.getText(), getCommentsProyecto())) {
										...
										JOptionPane.showMessageDialog(null, "�xito al crear proyecto, ingresa frentes");
					...
					if (modificar.isSelected()) {
						int res = JOptionPane.showConfirmDialog(null, "Confirmar para modificar", "Confirmaci�n", JOptionPane.YES_NO_OPTION);
					...
					if (eliminar.isSelected()) {
						int res = JOptionPane.showConfirmDialog(null, "Confirmar para eliminar", "Confirmaci�n", JOptionPane.YES_NO_OPTION);
						if (res == JOptionPane.YES_OPTION) {
							...
							if (existe == 0) {
								...
								JOptionPane.showMessageDialog(null, "No puede eliminar �ste proyecto tiene: " + existe + " frentes", "Error", JOptionPane.WARNING_MESSAGE);
								Tfrentes.setEnabled(true);
								fagregar.setEnabled(true);
								feliminar.setEnabled(true);
								aceptar.setEnabled(true);
			...
			TableColumn c2UbicacionColumn = Tfrentes.getColumn("Ubicaci�n");
			...
			fagregar.addActionListener(new ActionListener() {
				/**
				 * opci�n para agregar un nuevo frente al proyecto
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
			...
			feliminar.addActionListener(new ActionListener() {
				/**
				 * opci�n para eliminar un frente del proyecto
				 * (non-Javadoc)
				 * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
				 */
				public void actionPerformed(ActionEvent e) {
					if (idfrente > -1) {
						int res = JOptionPane.showConfirmDialog(null, "Deseas eliminar �ste frente", "Confirmaci�n", JOptionPane.YES_NO_OPTION);
						if (res == JOptionPane.YES_OPTION) {
