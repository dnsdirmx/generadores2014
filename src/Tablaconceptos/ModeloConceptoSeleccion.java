 ...
 * de la tabla de Conceptos de las estimaciones
 */
public class ModeloConceptoSeleccion implements TableModel {

	// lista de datos contenidos en el modelo
	private LinkedList < String > datos = new LinkedList < String >( );
	private LinkedList < TableModelListener > listeners = new LinkedList < TableModelListener >( );

	public ModeloConceptoSeleccion() {
	 ...
	 */
	public void anhadeAspecto ( String par ) {
		datos.add( par );
